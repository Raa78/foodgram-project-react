...
INGREDIENT_MIN_QUANTITY = 0.5  # пояснение на деплое и 2м ревью уберу
# 1/2 ст.л. можно заменить 1 ч.л., 1/2 ч.л. допускаю,
# мешьше 1/2 или 0.5 указывать меньше, наверное, уже не имеет смысла
